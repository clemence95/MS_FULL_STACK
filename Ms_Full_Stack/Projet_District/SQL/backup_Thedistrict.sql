...
(`id`),
  KEY `id_plat`
(`id_plat`),
  CONSTRAINT `commande_ibfk_1` FOREIGN KEY
(`id_plat`) REFERENCES `plat`
(`id`)
...
(`id`),
  KEY `id_categorie`
(`id_categorie`),
  CONSTRAINT `plat_ibfk_1` FOREIGN KEY
...
noix
de
muscade.\n\n',12.00,'lasagnes_viande.jpg\n',10,'Yes'),(17,'Tagliatelles
au saumon','Découvrez notre recette délicieuse de tagliatelles au saumon frais et à la crème qui qui vous assure un véritable régal!  \n\n',12.00,'tagliatelles_saumon.webp\n',10,'Yes');
...
-- Dump completed on 2023-09-11 15:20:06
