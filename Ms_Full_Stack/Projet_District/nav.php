<nav class="cc-navbar fixed-top navbar navbar-expand-lg navbar-dark md-3 w-100">
    <div class="container-fluid">
        <a class="navbar-brand text-uppercase mx-4 py-3 dancing" href="#">The Destrict</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-3 mb-lg-0 sm-3">
                ...
                <li class="nav-item pe-4">
                    <a class="nav-link dancing" href="#">Catégorie</a>
                </li>
                <li class="nav-item pe-4">
                    <a class="nav-link dancing " href="#">Plats</a>
                </li>
                <li class="nav-item pe-4">
